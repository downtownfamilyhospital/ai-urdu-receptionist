...
export async function getPatientMemory(whatsappNumber, isFresh = true) {
  try {
    ...
    note +=
      "**اہم:** خلاصے یا لیڈ میں کبھی 'known'، 'معلوم'، یا خالی نہ لکھیں — ہمیشہ اصل نام، اصل نمبر (923xxxxxxxxx)، اصل پتہ لکھیں۔ " +
      "یہ پرانی معلومات صرف آپ کی مدد کے لیے ہیں۔ **ان کی تصدیق صرف اُس وقت کریں جب مریض واقعی کوئی آرڈر/اپائنٹمنٹ بُک کر رہا ہو — عام سوال یا معلومات کے دوران بار بار تصدیق نہ مانگیں۔** " +
      "جب بُکنگ ہو رہی ہو تب ایک بار تصدیق کافی ہے، بار بار نہیں۔ اگر مریض نیا نام/پتہ/نمبر دے تو اپڈیٹ کر لیں۔)";
    return note;
  } catch (e) {
