...
export async function getPatientMemory(whatsappNumber, isFresh = true) {
  try {
    ...
    let note = "(یہ مریض پہلے آ چکا ہے۔ ہمارے پاس پرانی معلومات یہ ہیں (صرف آپ کی مدد کے لیے، انہیں 'known/معلوم' لکھ کر نہ ٹالیں): ";
    ...
    if (isFresh) {
      note +=
        "چونکہ یہ نئی گفتگو ہے، نام لے کر گرم جوشی سے سلام کریں " +
        "(مثلاً 'السلام علیکم [نام] جی! 🌸 بتائیں آج کیا خدمت کروں؟')۔ ";
    } else {
      note += "گفتگو جاری ہے — دوبارہ سلام/welcome back نہ کہیں۔ ";
    }
    note +=
      "**اہم:** خلاصے یا لیڈ میں کبھی 'known'، 'معلوم'، یا خالی نہ لکھیں۔ ہمیشہ اصل نام، اصل واٹس ایپ نمبر (923xxxxxxxxx مکمل)، اور اصل پتہ لکھیں۔ " +
      "پرانی معلومات کو حتمی نہ سمجھیں — نئی بُکنگ کے لیے مریض سے ہر چیز کی تصدیق کروائیں: نام لکھ کر پوچھیں 'کیا آپ کا نام [نام] درست ہے؟'، نمبر لکھ کر پوچھیں 'رابطے کے لیے یہی نمبر (923...) ٹھیک ہے؟'۔ مریض کی تصدیق کے بعد ہی آگے بڑھیں۔ " +
      "اگر مریض نیا نام/پتہ/نمبر دے تو اپڈیٹ کر لیں۔)";
    return note;
  } catch (e) {
